...
<body>
    ...
    <form action="/home/update/<?= $userId['id'];?>" method=post>
        <?= csrf_field(); ?>
        <table>
            <tr>
                <td>Nama</td>
                <td>:</td>
                <td><input type="text" name="nama" value="<?= $userId['nama'];?>"></td>
            </tr>
            <tr>
                <td>Email</td>
                <td>:</td>
                <td><input type="text" name="email" value="<?= $userId['nama'];?>"></td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
            ...
            <tr>
                <td>Alamat</td>
                <td>:</td>
                <td><input type="text" name="alamat" value="<?= $userId['alamat'];?>"></td>

            </tr>
            <tr>
                <td>Nick Valorant</td>
                <td>:</td>
                <td><input type="text" name="nick" value="<?= $userId['nick'];?>"></td>

            </tr>
            <tr>
                <td>Hastag</td>
                <td>:</td>
                <td><input type="text" name="hastag" value="<?= $userId['hastag'];?>"></td>

            </tr>
            <tr>
                <td>Main Hero</td>
                <td>:</td>
                <td><input type="text" name="hero" value="<?= $userId['hero'];?>"></td>
